...
- **Tema Oscuro**: ESTRICTAMENTE PROHIBIDO. El tema oscuro (dark mode) debe desactivarse por completo de todos los elementos de UI y de la configuración global de PrimeNG. Todos los componentes (modales, popovers, selectores, listas) deben tener siempre fondo blanco o claro, respetando el diseño de luz de la aplicación.
